...
const styles = StyleSheet.create({
    ...
    searchContainer: { zIndex: 100, marginBottom: 12 },
    searchBar: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    searchItemText: { color: C.textPrimary, fontWeight: '600', fontSize: 13, flex: 1 },
    noResultsText: { color: C.textTertiary, textAlign: 'center', padding: 16, fontSize: 13 },
    ...
    selectedExName: { color: C.textPrimary, fontSize: 24, fontWeight: '800', letterSpacing: -0.3 },
    ...
    statValue: { color: C.goldText, fontSize: 17, fontWeight: '800' },
    statUnit: { color: C.textTertiary, fontSize: 11, fontWeight: '700', marginTop: 4, textTransform: 'uppercase' },
    chartWrapper: {
        backgroundColor: C.glassFill,
        borderRadius: 16,
        padding: 12,
    ...
    chartTitle: { color: C.textSecondary, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.6 },
    chartUnit: { color: C.textTertiary, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    logLeft: { flex: 1 },
    logDate: { color: C.textPrimary, fontSize: 13, fontWeight: '700', marginBottom: 4 },
    ...
    logValLab: { color: C.textTertiary, fontSize: 11, fontWeight: '800', marginBottom: 4, letterSpacing: 0.5 },
    logVal: { color: C.goldText, fontSize: 15, fontWeight: '800' },
    emptyProgress: {
        alignItems: 'center',
        padding: 32,
        backgroundColor: C.glassFill,
    ...
    emptyProgressText: { color: C.textSecondary, textAlign: 'center', lineHeight: 20, fontSize: 13 },
    noExSelected: {
        alignItems: 'center',
        padding: 32,
        marginTop: 24,
