...
const styles = StyleSheet.create({
    ...
    emptyWrap: {
        ...
        paddingTop: 32, gap: 12, paddingHorizontal: 32,
    },
    ...
    unreadDotText: { color: VisualSystem.colors.textPrimary, fontSize: 11, fontWeight: '800' },
    statusDot: {
        position: 'absolute',
        bottom: 0,
        right: 0,
    ...
    goalBadge: { color: 'rgba(212,175,55,0.7)', fontSize: 11, marginTop: 4 },
    comingSoonBadge: {
        backgroundColor: 'rgba(212,175,55,0.1)',
        paddingHorizontal: 12,
        paddingVertical: 4,
