...
const styles = StyleSheet.create({
    ...
    createText: { color: VisualSystem.colors.textPrimary, fontWeight: '700', fontSize: 13 },
    ...
    emptyText: { color: VisualSystem.colors.textSecondary, fontSize: 15, fontWeight: '600' },
    ...
    friendAvatarText: { color: VisualSystem.colors.goldText, fontSize: 17, fontWeight: '700' },
    friendName: { color: VisualSystem.colors.textPrimary, fontSize: 15, fontWeight: '600' },
    friendGoal: { color: VisualSystem.colors.textTertiary, fontSize: 11, marginTop: 4 },
    checkCircle: {
        width: 28,
        height: 28,
        borderRadius: 16,
